...
module zmovie{
    export class ZMovieClip extends  egret.DisplayObjectContainer{
                ...
                for(var j:number = 0;j<f_len;j++){
                    ...
                    if(null == cfo.matrix){
                        ...
                        for(var o_name in cfo){
                            if("id" != o_name && "maskID" != o_name && "op" != o_name && "mcName" != o_name && "matrix" != o_name && "al" != o_name && "libName" != o_name && "f_arr" != o_name && "cx" != o_name && "cy" != o_name && "r" != o_name && "sx" != o_name && "sy" != o_name){
                                delete cfo[o_name];
                            }
                        }
                        if(null != obj3d){
        ...
        var children:number = this.numChildren-1;
        if(0 == children){
            this.addChild(id);
            return;
        }
        for(var i:number = children;i>=0;i--){
            try{
